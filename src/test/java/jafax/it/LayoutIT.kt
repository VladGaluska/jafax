...
class LayoutIT {
    ...
    private fun verifyClient(client: Class) {
        ...
        assertTrue(client.fileName?.endsWith("src/test/resources/org/radum/Client.java") ?: false)
    ...
    private fun verifyDataObject(dataObject: Class) {
        ...
        assertTrue(dataObject.fileName?.endsWith("src/test/resources/org/radum/DataObject.java") ?: false)
    ...
    private fun verifyExtendedData(extendedData: Class) {
        ...
        assertTrue(extendedData.fileName?.endsWith("src/test/resources/org/radum/ExtendedData.java") ?: false)
    ...
    private fun verifyProvider(provider: Class) {
        ...
        assertTrue(provider.fileName?.endsWith("src/test/resources/org/radum/Provider.java") ?: false)
    ...
    private fun verifyEmpty(empty: Class) {
        ...
        assertTrue(empty.fileName?.endsWith("src/test/resources/org/radum/Client.java") ?: false)
    ...
    private fun verifyIProvider(iProvider: Class) {
        ...
        assertTrue(iProvider.fileName?.endsWith("src/test/resources/org/radum/IProvider.java") ?: false)
    ...
    private fun verifyProviderFactory(providerFactory: Class) {
        ...
        assertTrue(providerFactory.fileName?.endsWith("src/test/resources/org/radum/Provider.java") ?: false)
